...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("UPDATED_AT"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>LINK.LAST_CHECK_AT</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_CHECK_AT = createField(DSL.name("LAST_CHECK_AT"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>LINK.LAST_COMMIT_AT</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_COMMIT_AT = createField(DSL.name("LAST_COMMIT_AT"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>LINK.ISSUES_COUNT</code>.
     */
    public final TableField<LinkRecord, Integer> ISSUES_COUNT = createField(DSL.name("ISSUES_COUNT"), SQLDataType.INTEGER, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super Long, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super Integer, ? super Integer, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super Long, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super Integer, ? super Integer, ? extends U> from) {
